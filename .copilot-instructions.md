- Check if tavily mcp search and extract are available, and if so use them as necessary for research including but not limited to finding the most recent version of documentation.
